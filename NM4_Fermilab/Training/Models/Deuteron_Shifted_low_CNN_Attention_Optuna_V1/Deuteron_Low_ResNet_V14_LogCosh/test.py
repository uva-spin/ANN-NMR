...
# Load the model
model = keras.models.load_model('Models/Deuteron_Low_ResNet_V14_LogCosh/best_model.keras', 
...
output_file_path = 'Models/Deuteron_Low_ResNet_V14_LogCosh/model_summary.json'
