...
for i in range(10): #Loop over 15E3 times 
    ### Proton Stuff ###
...
try:
    df.to_csv(os.path.join(file_path,'Test' + str(sys.argv[1]) + '.csv'), index=False)
