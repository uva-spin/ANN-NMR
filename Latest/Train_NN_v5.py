...
df = pd.read_csv('Sample_Data_1M.csv')
...
csv_logger = CSVLogger('log_1M_V1.csv', append=True, separator=';')
...
model_tuned.save('Trained_model_1M_V1_tuned.h5', save_format='h5')
plt.figure()
...
plt.savefig('Loss_Plot_V1_tuned.png')
